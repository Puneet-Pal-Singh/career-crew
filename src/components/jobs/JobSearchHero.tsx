...
export default function JobSearchHero() {
  ...
  return (
    <div className="text-center py-12 md:py-20 px-4 rounded-xl 
      ...
      <div className="mt-8 mx-auto max-w-3xl grid grid-cols-1 md:grid-cols-2 gap-4 items-center p-2 bg-white dark:bg-card rounded-full shadow-lg border">
        <div className="relative">
          ...
          <Input
            ...
            className="w-full rounded-full border-none pl-12 h-12 text-md focus-visible:ring-0 focus-visible:ring-offset-0"
          />
        </div>
        <div className="relative">
