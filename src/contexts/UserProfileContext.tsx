...
// import React, { createContext, useContext, useState, useEffect, ReactNode, useCallback } from "react";
// // FIX: Use the correct path to your existing Supabase client instance
// import { supabase } from "@/lib/supabaseClient"; 
// import { useAuth } from "./AuthContext";
...
//     setIsLoadingProfile(true);
//     setProfileError(null);
//     // NOTE: We don't need to create a client, we import the existing one.
...
//       if (error) {
//         console.warn("UserProfileContext: Could not fetch profile. This is expected for new users.", error.message);
//         setUserProfile(null); 
//       } else {
//         setUserProfile(data as UserProfile);
//       }
...
//       console.error("UserProfileContext: fetchUserProfile caught error:", message);
//       setProfileError(new Error(message));
//       setUserProfile(null);
//     } finally {
//       setIsLoadingProfile(false);
